<template>
    <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12 legal">
        <h1>Privacy Policy</h1>
        <p>Government Technology Agency</p>
        <h2>Government Agency Privacy Policy</h2>
        <div>
          This Privacy Policy must be read in conjunction with the Terms of Use that accompany the applicable service you are requesting from us (the <b>“Service”</b>). In this Privacy Policy, <b>“Public Sector Entities”</b> means the Government (including its ministries, departments and organs of state) and public authorities (such as statutory boards).
        </div>
        <ol>
          ...
          <li>You may withdraw your consent to the use and disclosure of your data by us with reasonable notice and subject to any prevailing legal or contractual restrictions; however, doing so may prevent the proper functioning of the Service and may also result in the cessation of the Service to you.</li>
          <li>The Service may contain links to non-Public Sector Entity sites whose data protection and privacy practices may differ from ours.  We are not responsible for the content and privacy practices of these other websites and encourage you to consult the privacy notices of those sites.</li>
          <li>Please contact 1800 211 0777 or qsm@tech.gov.sg if you:
            <ol>
        ...
        <center><h2><b>ANNEX</b></h2></center>
        <ol type="i">
          <li><b>Name of Service:</b> Beeline</li>
          <li><b>Types of data requested</b>
            <ol type="a">
