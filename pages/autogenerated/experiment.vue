  ...
  <div class="container">
    ...
    <div style="display: flex">
      <div style="flex-basis: 50%">
        ...
        <div>
          <label>
            Suboptimal Stop Choice Allowance
            <input type="text" v-model.number.lazy="settings.suboptimalStopChoiceAllowance" />
          </label>
        </div>
        <div>
          <label>
...
import CountSimilar from '~/components/CountSimilar'
